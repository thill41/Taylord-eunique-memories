...
class PackageFlowsTest < BaseIntegrationTest
  ...
  test 'requires authentication' do
    ...
    requires_authentication { post packages_path params: { package: { name: 'Package 1', price: 10, position: 1, content: 'New Description', enabled: true } } }
  ...
  test 'creating a package' do
    ...
    post packages_path, params: { package: { name: 'Package 2', price: 10, position: 1, content: 'New Description', enabled: true } }
  ...
  test 'invalid create package' do
    post packages_path, params: { package: { price: 10, content: 'New Description', enabled: true } }
  ...
  test 'invalid edit package' do
    patch package_path(@package), params: { package: { price: nil } }
